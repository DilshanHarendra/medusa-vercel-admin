...
import type Menu from '../../src/modules/menu'
import type Blog from '../../src/modules/blog'
import type ProductWidget from '../../src/modules/productWidget'
import type ProductReview from '../../src/modules/review'
import type Page from '../../src/modules/page'
...
declare module '@medusajs/framework/types' {
  interface ModuleImplementations {
    ...
    'menu': InstanceType<(typeof Menu)['service']>,
    'blog': InstanceType<(typeof Blog)['service']>,
    'productWidget': InstanceType<(typeof ProductWidget)['service']>,
    'productReview': InstanceType<(typeof ProductReview)['service']>,
    'page': InstanceType<(typeof Page)['service']>
  }
}