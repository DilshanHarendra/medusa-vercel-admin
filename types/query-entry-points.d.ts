...
export type Product = {
  ...
  product_widget_link: Maybe<LinkProductProductWidget>;
  product_widget: Maybe<ProductWidget>;
};
...
export type Menu = {
  ...
  id: Scalars['ID']['output'];
  name: Scalars['String']['output'];
  children: Array<Maybe<MenuItems>>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
};
...
export type BlogPost = {
  ...
  url_handle: Scalars['String']['output'];
...
export type ProductWidget = {
  ...
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  product_link: Maybe<LinkProductProductWidget>;
  product: Maybe<Product>;
};
...
export type LinkProductProductWidget = {
  __typename?: 'LinkProductProductWidget';
  product_id: Scalars['String']['output'];
  product_widget_id: Scalars['String']['output'];
  product: Maybe<Product>;
  product_widget: Maybe<ProductWidget>;
  createdAt: Scalars['String']['output'];
  updatedAt: Scalars['String']['output'];
...
declare module '@medusajs/framework/types' {
  interface RemoteQueryEntryPoints {
    ...
    product_product_widget: LinkProductProductWidget
  }
}